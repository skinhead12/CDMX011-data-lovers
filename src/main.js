...
allCharacters() ;
    function allCharacters() { //declaramos funcion
        info.map((objeto)=>{ // creando nvo array a info con map
          ...
          const template = `<div class="tarjetas"><h1 class='name'> Name: ${objeto.name}</h1> <h2 class='gender'>Gender: ${objeto.gender}</h2><h3 class='species'> Specie: ${objeto.species}</h3><h4 class='origin'> Origin: ${objeto.origin.name}</h4>
